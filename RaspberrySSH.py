...
class RaspberryPi1(SSHClientBase):
...
class RaspberryPi2(SSHClientBase):
...
if __name__ == "__main__":
    raspberry1 = RaspberryPi1('192.168.0.107', 'konradkrauze', '1984')
    raspberry2 = RaspberryPi2('192.168.0.106', 'jacks', 'jacks')
    while True:
